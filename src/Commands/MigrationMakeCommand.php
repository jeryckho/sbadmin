...
use jeryckho\sbadmin\Migrations\NameParser;
use jeryckho\sbadmin\Migrations\SchemaParser;
use jeryckho\sbadmin\Migrations\SyntaxBuilder;
...
class MigrationMakeCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'sb:migration:schema';
